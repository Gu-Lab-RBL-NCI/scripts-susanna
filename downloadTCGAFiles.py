...
## PURPOSE: download files from TCGA datasets
## INPUT: manifest data from CGC 	all-tumor-manifest.tsv
## OUTPUT: gene/miRNA expression files 		FPKM-UQ/mirna.quantification.txt
##		   gene/miRNA expression metadata 	tumor-expression type-expression-manifest.csv
